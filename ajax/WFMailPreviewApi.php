...
$filesurls = optional_param_array("urls", array(), PARAM_URL);
$emailsLists = optional_param_array("manual_emails", array(), PARAM_TEXT);
$filesRoleList = optional_param_array("files_role", array(), PARAM_TEXT);
$manualEmailsRoleList = optional_param_array("manual_emails_role", array(), PARAM_TEXT);

$csvGroupsLists = optional_param_array("csv_groups_lists", array(), PARAM_TEXT);
$manualGroupsLists = optional_param_array("manual_groups_lists", array(), PARAM_TEXT);
