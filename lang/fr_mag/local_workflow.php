...
Pour une formation publiée dans l\'offre de formation en libre accès de m@gistère, la durée permet aux personnes intéressées d\'évaluer le niveau d\'engagement';
...
$string['link_publish'] = 'Publier sur l’offre de formation en libre accès';
$string['link_publish_cancel'] = 'Retirer la publication';
$string['link_publish_update'] = 'Mettre à jour la publication';
$string['link_share'] = 'Publier sur l’offre de parcours à déployer';
$string['link_share_cancel'] = 'Retirer la publication';
$string['link_share_update'] = 'Mettre à jour la publication';

$string['link_publish_disable'] = 'Publier une session dans l\'offre de formation en libre accès';
$string['link_publish_disable_help'] = 'La publication dans l\'offre de formation en libre accès est désactivée car les conditions ne sont pas remplies
pour pouvoir y accéder. Veuillez vérifier les informations suivantes :
<ul>
...
$string['link_local_publish'] = 'Publier sur l\'offre de formation en libre accès locale';
$string['link_local_publish_disable'] = 'Publier une session dans l\'offre de formation en libre accès locale';
$string['link_local_publish_disable_help'] = 'La publication dans l\'offre de formation en libre accès locale est désactivée car les conditions ne sont pas remplies
pour pouvoir y accéder. Veuillez vérifier les informations suivantes :
<ul>
...
$string['link_share_disable'] = 'Publier un parcours dans l\'offre de parcours à déployer';
$string['link_share_disable_help'] = 'La publication dans l\'offre de parcours à déployer est désactivée car les conditions ne sont pas remplies
pour pouvoir y accéder. Veuillez vérifier les informations suivantes :
<ul>
...
$string['msg_local_publish_discard_success'] = 'La session locale a bien été dépubliée de l\'offre de formation en libre accès';
$string['msg_local_publish_success'] = 'La session locale a bien été publiée dans l\'offre de formation en libre accès';
$string['msg_publish_discard_success'] = 'La session a bien été dépubliée de l\'offre de formation en libre accès';
$string['msg_publish_success'] = 'La session a bien été publiée dans l\'offre de formation en libre accès';
$string['msg_share_discard_success'] = 'Le parcours a bien été dépublié de l\'offre de parcours à déployer';
$string['msg_share_success'] = 'Le parcours a bien été publié dans l\'offre de parcours à déployer';
...
$string['purge_trashed_courses_task'] = 'Suppression des parcours en corbeille';

$string['status_course_not_published'] = 'Parcours non publié';
$string['status_local_publish'] = 'Session locale publiée';
$string['status_local_publish_course'] = 'Session locale publiée sur l’offre de formation en libre accès';
$string['status_publish'] = 'Session publiée';
$string['status_publish_course'] = 'Session publiée sur l’offre de formation en libre accès';
$string['status_share'] = 'Parcours publié';
$string['status_share_course'] = 'Parcours publié sur l’offre de parcours à déployer';
...
$string['optimizer_mail_subject'] = '[m@gistère] Détails de l\'optimisation réalisée sur le parcours "{$a}"';
$string['optimizer_mail_body'] = 'Bonjour,

Vous trouverez en pièce jointe de ce mail un fichier contenant les détails de l\'optimisation réalisée le {$a->date} à {$a->time} sur le parcours "{$a->coursename}".

Ceci est un message automatique. Merci de ne pas répondre à ce courriel.';

$string['workflow_notification_task'] = 'Système de notification du workflow';